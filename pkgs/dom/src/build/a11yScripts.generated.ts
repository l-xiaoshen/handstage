...
export const a11yScriptSources = {
	...
	getScrollOffsets:
		"function a() {\n  try {\n    let r = window.scrollX ?? window.pageXOffset ?? document.documentElement?.scrollLeft ?? 0, s = window.scrollY ?? window.pageYOffset ?? document.documentElement?.scrollTop ?? 0;\n    return { sx: Number(r) || 0, sy: Number(s) || 0 };\n  } catch {\n    return { sx: 0, sy: 0 };\n  }\n}",
	nodeToAbsoluteXPath:
...
export const a11yScriptGlobalRefs = {
	documentHasFocusStrict:
		"globalThis.__handstageA11yScripts.documentHasFocusStrict",
	...
	resolveDeepActiveElement:
		"globalThis.__handstageA11yScripts.resolveDeepActiveElement",
} as const
