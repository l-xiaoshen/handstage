...
/**
 * Per-instance log routing for Handstage.
 *
 ...
 * directly.  Multiple Handstage instances therefore route their logs to their own
 ...
 * console fallback).  Used by Handstage at construction time to wrap the user's
